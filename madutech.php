        ...
        <div class="main-container">
            <section>
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <h1>Madutech Nigeria Limited</h1>
                            ...
                            <div class="boxed bg--secondary boxed--lg boxed--border">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 col-md-6 col-xs-6">
                                        <ul>
                                            <li>MADUTECH</li><!-- fradril spelling -->
                                            <li>Web Design</li>
                                            <li>April 2017</li>
                                            <li>2 weeks</li>
                                            <li>Lagos</li>
                                            <li><a href="http://madutechng.com" target="blak_" class="btn btn-info">View Site</a></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="row">
                                <div class="col-sm-6">
                                        ...
                                        <img alt="Thumb" src="img/madu.png" />
                                    
                                </div>
                                <div class="col-sm-6">
                                    
                                        <img alt="Thumb" src="img/madu2.png" />
                            ...
                            <div class="row">
                                <div class="col-sm-6 mt--1">
                                        ...
                                        <img alt="Thumb" src="img/madu3.png" />
                                    
                                </div>
                                <div class="col-sm-6 mt--1">
                                    
                                        <img alt="Thumb" src="img/madu4.png" />
